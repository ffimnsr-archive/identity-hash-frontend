...
if((i < len)){
var k = (ks[i]);
var G__14696 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__14697 = (i + (1));
m = G__14696;
i = G__14697;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14701 = c;
var G__14701__$1 = (((G__14701 == null))?null:G__14701.prototype);
if((G__14701__$1 == null)){
return null;
} else {
return (G__14701__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14705 = c;
var G__14705__$1 = (((G__14705 == null))?null:G__14705.prototype);
if((G__14705__$1 == null)){
return null;
} else {
return (G__14705__$1["render"]);
}
})() == null)));
});
...
var G__14709 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14709) : reagent.impl.component.as_element.call(null,G__14709));
};
...
while (G__14712__i < G__14712__a.length) {G__14712__a[G__14712__i] = arguments[G__14712__i + 0]; ++G__14712__i;}
  args = new cljs.core.IndexedSeq(G__14712__a,0,null);
} 
...
var _STAR_current_component_STAR_14716 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14716;
}});
...
return ((function (G__14724,G__14724__$1){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__14727 = reagent.impl.component.state_atom(c);
var G__14728 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__14727,G__14728) : cljs.core.reset_BANG_.call(null,G__14727,G__14728));
});
;})(G__14724,G__14724__$1))
...
var or__7960__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__7960__auto__){
...
var c = this;
var G__14730_14732 = (c["cljsRatom"]);
if((G__14730_14732 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14730_14732);
}
...
if(cljs.core.truth_((function (){var and__7948__auto__ = wrap;
...
var renders_14735 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_14736 = cljs.core.first(cljs.core.vals(renders_14735));
if((cljs.core.count(renders_14735) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_14735))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_14736)){
} else {
...
var render_fun = (function (){var or__7960__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7960__auto__)){
return or__7960__auto__;
} else {
...
var render_fun__$1 = (function (){var or__7960__auto__ = render_fun;
if(cljs.core.truth_(or__7960__auto__)){
return or__7960__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7960__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7960__auto__)){
return or__7960__auto__;
} else {
...
var name__$1 = (function (){var G__14734 = name;
switch (G__14734) {
case "":
...
var elem = (function (){var G__14745 = (function (){var or__7960__auto__ = (function (){var G__14747 = c;
if((G__14747 == null)){
return null;
} else {
return (G__14747["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__7960__auto__)){
return or__7960__auto__;
...
return (G__14745["_currentElement"]);
}
})();
var name = (function (){var G__14748 = elem;
var G__14748__$1 = (((G__14748 == null))?null:(G__14748["type"]));
if((G__14748__$1 == null)){
return null;
} else {
return (G__14748__$1["displayName"]);
}
})();
var path = (function (){var G__14749 = elem;
var G__14749__$1 = (((G__14749 == null))?null:(G__14749["_owner"]));
var G__14749__$2 = (((G__14749__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__14749__$1) : reagent.impl.component.component_path.call(null,G__14749__$1)));
if((G__14749__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14749__$2),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" > ")].join('');
}
})();
...
var n = (function (){var or__7960__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__7960__auto__)){
return or__7960__auto__;
} else {
var G__14751 = c;
var G__14751__$1 = (((G__14751 == null))?null:G__14751.constructor);
if((G__14751__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__14751__$1);
}
}
})();
