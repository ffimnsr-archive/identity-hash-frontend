...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8617__auto__,writer__8618__auto__,opt__8619__auto__){
return cljs.core._write(writer__8618__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14781 = o;
(G__14781[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__14783__i < G__14783__a.length) {G__14783__a[G__14783__i] = arguments[G__14783__i + 0]; ++G__14783__i;}
  args = new cljs.core.IndexedSeq(G__14783__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__7948__auto__ = !((jsprops == null));
if(and__7948__auto__){
var and__7948__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__14789 = jsprops;
(G__14789["defaultValue"] = value);

(G__14789["onChange"] = ((function (G__14789,v,value,on_change){
return (function (p1__14787_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14787_SHARP_);
});})(G__14789,v,value,on_change))
);
...
var vec__14796 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14796,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14796,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14796,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___14801 = reagent.impl.template.key_from_vec(v);
if((temp__5282__auto___14801 == null)){
} else {
var key_14802 = temp__5282__auto___14801;
(jsprops["key"] = key_14802);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14804 = reagent.impl.template.__GT_NativeWrapper();
(G__14804["name"] = c);
...
var G__14806 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14806) : reagent.impl.template.as_element.call(null,G__14806));
} else {
...
var len__9181__auto___14812 = arguments.length;
var i__9182__auto___14813 = (0);
while(true){
if((i__9182__auto___14813 < len__9181__auto___14812)){
args__9188__auto__.push((arguments[i__9182__auto___14813]));

var G__14814 = (i__9182__auto___14813 + (1));
i__9182__auto___14813 = G__14814;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9189__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14810){
var G__14811 = cljs.core.first(seq14810);
var seq14810__$1 = cljs.core.next(seq14810);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14811,seq14810__$1);
});
...
break;
default:
var G__14818 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14818;
continue;
...
var n__8981__auto___14821 = a.length;
var i_14822 = (0);
while(true){
if((i_14822 < n__8981__auto___14821)){
(a[i_14822] = reagent.impl.template.as_element((a[i_14822])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8981__auto___14824 = a.length;
var i_14825 = (0);
while(true){
if((i_14825 < n__8981__auto___14824)){
var val_14826 = (a[i_14825]);
if((cljs.core.vector_QMARK_(val_14826)) && ((reagent.impl.template.key_from_vec(val_14826) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14825] = reagent.impl.template.as_element(val_14826));
...
var ctx = ({});
var vec__14831 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14831,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14831,(1),null);
...
var G__14835 = (cljs.core.count(argv) - first_child);
switch (G__14835) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__14835){
